...
<body>
    ...
    <div class="container2">
        <div class="text-wrapper">
            <div class="text-1 text">Our</div>
            <div class="text-2 text">Our</div>
            <div class="text-3 text">Our</div>
            <div class="text-4 text">Our</div>
            <div class="text-5 text">Our</div>
            <div class="text-6 text">TROPHIES</div>
            <div class="text-7 text">Our</div>
            <div class="text-8 text">Our</div>
            <div class="text-9 text">Our</div>
            <div class="text-10 text">Our</div>
            <div class="text-11 text">Our</div>
        </div>
    </div>    
